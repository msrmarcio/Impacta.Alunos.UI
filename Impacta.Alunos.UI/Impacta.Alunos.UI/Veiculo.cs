...
{
    class Veiculo : VeiculoBasico, ICadastro
    {
        ...
        //Definir as propriedades aqui ...
        //Utilizando as propriedades autoimplementadas
        // prop + tab + tab
        ...
        //Este método foi adicionado pela interface ICadastro
        ...
        public void Gravar()
        {
            ...
            string registro = string.Format(
                ...
                Marca, Combustivel.ToString(), Cambio.ToString(), Observacao.Replace(";", ""),
